...
function setup() {
  ...
  attach = new Throw (Superhero.Body,{x:100,x:465});
  block1 = new Block(280,350,30,40);
  block2 = new Block(310,350,30,40);
  block3 = new Block(340,350,30,40);
  block5 = new Block(370,350,30,40);
  block6 = new Block(400,350,30,40);
  block7 = new Block(430,350,30,40);
...
function mouseDragged(){
  Matter.Body.setPosition(superhero.boy,{mouseX,mouseY});
